...
const MediaManagement = () => {
  ...
  const medias = [
    {
      id: 233,
      title: 'Sunday Worship Audio',
      description: 'An inspiring Sunday message on faith and grace.',
      file_path: '/media/audio/sunday-worship.mp3',
      file_type: 'audio',
      file_size: 5242880,
      price: 100.0,
      duration: '22:12'
              ...
              {medias.map((media) => (
                <div key={media.id}>
                  <div className=" flex flex-col items-center text-center justify-center border border-[#0D47A1] rounded-lg p-4 ">
                    ...
                    <h1 className="font-bold text-[25px] mt-15  ">{media.title}</h1>
                    <h3 className="font-semibold text-[18px]  ">
                      Duration: {media.duration} / {media.file_size}MB{' '}
                    </h3>
