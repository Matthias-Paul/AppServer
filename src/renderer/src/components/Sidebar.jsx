  ...
  return (
    ...
    >
      <div className="flex justify-between items-center px-4 py-6">
        {!isCollapsed && <span className="text-xl pl-[9px] font-semibold">Media Unboxed </span>}
        <button
      ...
      <nav className="flex flex-col">
        {[
          ...
          <NavLink
            ...
            key={to}
            className={({ isActive }) =>
              `${isActive ? 'text-[#0D47A1] bg-[#E3F2FD] ' : ''} py-4 px-4 flex items-center transition-all duration-200 ${
                isCollapsed ? 'justify-center' : 'justify-start gap-x-3 px-6'
              }`
            }
          >
            {icon}
        ...
        <button
          ...
          className={`py-4 px-4 flex cursor-pointer items-center w-full text-left transition-all duration-200  ${
            isCollapsed ? 'justify-center' : 'justify-start gap-x-3 px-6'
          }`}
        >
